...
export {
  ...
  FUNDS_PHASE_ENUM_META, FUNDS_PHASE_ENUM,
...
angular.module('@@app.constants', [])
  ...
  .constant('FUNDS_PHASE_ENUM_META', FUNDS_PHASE_ENUM_META)
  .constant('COMPANY_SEARCH_PHASE', COMPANY_SEARCH_PHASE)
  .constant('COMPANY_SEARCH_PHASE_META', COMPANY_SEARCH_PHASE_META)
  .constant('COMPANY_INDUSTRY', COMPANY_INDUSTRY)
  .constant('COMPANY_INDUSTRY_META', COMPANY_INDUSTRY_META);
